...
/**
 * __useQueryRepoQuery__
 *
 * To run a query within a React component, call `useQueryRepoQuery` and pass it any options that fit your needs.
 * When your component renders, `useQueryRepoQuery` returns an object from Apollo Client that contains loading, error, and data properties
...
export function useQueryRepoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<QueryRepoQuery, QueryRepoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<QueryRepoQuery, QueryRepoQueryVariables>(QueryRepoDocument, options);
        }
